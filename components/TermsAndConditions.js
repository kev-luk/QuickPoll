      ...
      <ScrollView>
        <View style={styles.header}>
          ...
          <Text style={{ marginHorizontal: 15 }} category="p1">
            ...
            property rights related to it, still belong to CometShare.
          </Text>

          <Text style={{ marginHorizontal: 15 }} category="p1">
            CometShare is committed to ensuring that the app is as useful and
          ...
          <Text style={{ marginHorizontal: 15 }} category="p1">
            You should be aware that there are certain things that CometShare
            ...
            provider, but CometShare cannot take responsibility for the app not
          ...
          <Text style={{ marginHorizontal: 15 }} category="p1">
            ...
            same lines, CometShare cannot always take responsibility for the way
            ...
            avail the Service, CometShare cannot accept responsibility.
          </Text>
          <Text style={{ marginHorizontal: 15 }} category="p1">
            With respect to CometShare’s responsibility for your use of the app,
            ...
            so that we can make it available to you. CometShare accepts no
          ...
          <Text style={{ marginHorizontal: 15 }} category="p1">
            ...
            you want to keep using the app. CometShare does not promise that it
          ...
          <Text style={{ marginHorizontal: 15 }} category="p1">
            ...
            Conditions, do not hesitate to contact us at support@cometshare.com.
          </Text>
        </View>
      </ScrollView>
    </Layout>
